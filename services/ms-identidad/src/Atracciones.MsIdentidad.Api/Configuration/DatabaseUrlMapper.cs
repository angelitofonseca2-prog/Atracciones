namespace Atracciones.MsIdentidad.Api.Configuration;

/// <summary>
/// Convierte DATABASE_URL (postgres://user:pass@host:port/db) a formato Npgsql.
/// Invocar antes de WebApplication.CreateBuilder(args) en Program.cs.
/// </summary>
