...
namespace Atracciones.MsClientes.Api.Hosted;

/// <summary>
/// Carga JWKS en segundo plano con reintentos para no impedir que Kestrel arranque si ms-identidad aún no está en :5101.
/// </summary>
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            ...
            catch (Exception ex)
            {
                _logger.LogWarning(ex,
                    "No se pudo cargar JWKS desde {Url}; el API sigue escuchando (p. ej. GET /health). Reintento en {Seconds}s.",
                    _jwt.JwksUrl,
