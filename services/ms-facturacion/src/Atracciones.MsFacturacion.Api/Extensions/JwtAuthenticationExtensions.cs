...
using Atracciones.MsFacturacion.Api.Hosted;
using Atracciones.MsFacturacion.Api.Models.Common;
using Atracciones.MsFacturacion.Api.Options;
using Atracciones.MsFacturacion.Api.Security;
using Microsoft.AspNetCore.Authentication.JwtBearer;

namespace Atracciones.MsFacturacion.Api.Extensions;
