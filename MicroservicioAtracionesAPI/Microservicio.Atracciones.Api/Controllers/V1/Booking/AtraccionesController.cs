...
/// 
///   GET /api/v2/atracciones          → listado paginado con filtros
///   GET /api/v2/atracciones/filtros  → opciones de filtrado por ciudad
///   GET /api/v2/atracciones/{guid}   → detalle completo
/// 
